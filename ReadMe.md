...
This is on my way to be a professional software engineer. I hope to get an ideal job in BAT or some companies like that.

> Inspired by John Washam, I invoked his plan for becoming a software engineer. 
> I will using to-do list, stick notes along with the markdown to plan and record study topics.

## What is it?

This is my multi-month study plan for going from a junior software engineer (self-taught, no CS degree) to software engineer for a large company.

This is meant for **new software engineers** or those switching from junior software development to software engineering (where computer science knowledge is required). 

I hope when the list grows larger, I can be eligible to be a software engineer for Microsoft or the equivalent companies. 

I am also insterested in a reliability engineer or operations engineer, study more from the optional list (networking, security).
...
- [Coding](#coding)
  ...
  - [Main Languages for the Interview](#main-languages-for-the-interview)
  - [Tips](#tips)
  - [Practice](#practice)
...
## Main Languages for the Interview
Target: comfortable in the language and be knowledgeable.
...
<!-- TODO to find a pdf version of this book -->
